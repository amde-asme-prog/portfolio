  ...
  return (
    ...
    >
      ...
      <div className="mt-8 text-3xl flex flex-col gap-5 h-full self-center   ">
        <div className="flex flex-col gap-y-4 mt-8">
          <div className="flex items-center gap-x-2">
            ...
            <div className="not-italic text-lg text-text_secondary ml-2">
              ...
              <address className="font-bold text-lg text-text_accent text-wrap">
        ...
        <motion.button
          className=" w-fit uppercase rounded-3xl bg-blue-600 text-white px-5 py-3 flex flex-row items-center gap-3 text-lg border-2 border-border_primary "
