...
const Skills = () => {
  ...
  const skills = {
    technicalSkills: [
      ...
      { name: "React Native", level: 70, icon: "react", part: "mobile-app" },
      { name: "Next.js", level: 70, icon: "react", part: "front-end" },
      { name: "Vue", level: 50, icon: "vuejs", part: "front-end" },
      { name: "Flutter", level: 80, icon: "flutter", part: "mobile-app" },
      { name: "Node.js", level: 60, icon: "node-js", part: "back-end" },
      { name: "Express.js", level: 70, icon: "server", part: "back-end" },
      { name: "TailwindCSS", level: 85, icon: "css3-alt", part: "front-end" },
      { name: "Java", level: 50, icon: "java", part: "back-end" },
      { name: "Laravel", level: 80, icon: "laravel", part: "back-end" },
    ],
    professionalSkills: [
