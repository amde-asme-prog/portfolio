					...
					<article className="flex gap-4 h-full md:w-[90vw] justify-center items-center overflow-clip">
						<AnimatePresence mode="wait">
							<motion.div
								...
								className="inline-flex self-center h-[37rem]  w-[22rem] sm:w-80 lg:w-96">
						...
						<AnimatePresence mode="wait">
							<motion.div
								...
								dragElastic={0.1}
								onDragEnd={handleDragEnd}
								className="hidden md:inline-flex self-center h-[37rem] w-[22rem] sm:w-80 lg:w-96">
								<Project
						...
						<AnimatePresence mode="wait">
							<motion.div
								...
								dragElastic={0.1}
								onDragEnd={handleDragEnd}
								className="hidden lg:inline-flex self-center h-[37rem] w-[22rem] sm:w-80 lg:w-96">
								<Project
	...
	return (
		<article className="self-center justify-center flex flex-col bg-background_secondary text-sub_heading border border-background_primary rounded-lg shadow-lg w-96 h-[32rem] text-left transition-transform duration-500 hover:shadow-xl">
			...
			<div className="my-6 flex space-x-4 justify-center">
				<a
					href={project.github}
					className="inline-flex items-center px-4 py-2 border-2 border-button_border text-sm font-medium rounded-md text-text_subtle bg-button_secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
