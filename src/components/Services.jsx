...
const Services = () => {
	...
	return (
		<section
			id="services"
			className="text-center w-full py-24 bg-background_primary">
			<h1 className="text-4xl font-bold mb-12 text-heading">Services</h1>
			<div className="flex flex-wrap justify-center gap-8">
				{services.map((service, index) => (
					<div
						key={index}
						className="bg-background_secondary p-8 rounded-lg shadow-lg w-80 text-left transform hover:scale-105 transition-transform">
